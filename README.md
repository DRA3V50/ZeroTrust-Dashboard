...
|---------|--------|-----------|
| A.12.7 | Technical Vulnerability Management | 55 |
| A.5.1 | InfoSec Policies | 33 |
| A.6.1 | Org InfoSec | 20 |
| A.8.2 | Risk Management | 36 |
| A.9.2 | Access Control | 97 |
| Application | Application | 87 |
| Data | Data | 14 |
| Device | Device | 5 |
| Identity | Identity | 98 |
| Network | Network | 51 |
